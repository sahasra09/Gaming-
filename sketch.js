...
function setup() {
  ...
  bg=createSprite(displayWidth/2-200,displayHeight/2,displayWidth,displayHeight);
...
//  rb.addImage("rb",rbImage);
 // rb.scale=0.15;
  ...
  invisibleGround=createSprite(displayWidth/2,displayHeight/2+200,displayWidth,20);
